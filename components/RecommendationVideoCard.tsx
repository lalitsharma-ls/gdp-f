...
const VideoCard = ({
  ...
  return (
    <Link href={`/video/${uid}/title`} scroll={true}>
      <div className="grid grid-cols-12 gap-2 cursor-pointer group">
        <div className="aspect-video relative rounded-lg overflow-hidden col-span-4">
          <Image
            src={thumbnail}
            alt={title}
            fill
        ...
        {/* Video Info */}
        <div className="flex flex-col gap-1 col-span-8 h-full justify-stretch ">
